 ...
 */
metadata {
	definition (name: "Yale Conexis L1 Lock", namespace: "plasmasoft", author: "PlasmaSoft", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		capability "Actuator"
		capability "Lock"
		capability "Polling"
		capability "Refresh"
